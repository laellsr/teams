            ...
            while(have_posts()): the_post(); ?>
                    <div class="standing-list-cover col-3">
                        <div class="standing-team-list">
                            <div class="mb-3">
                                <div class="">
                                    <span class="logo"><a target="_blank" href="<?php the_field('imagem'); ?>"><img class="" src="<?php the_field('imagem'); ?>" style="width: auto; height: 120px"></a></span>
                                </div>
                                <div class="mt-4">
                                    <a href="<?php the_permalink(); ?>"><h4 class="result-title"><?php the_title(); ?></h4></a>
